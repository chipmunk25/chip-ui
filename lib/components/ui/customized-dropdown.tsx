...
export const CustomizedMultiDropDown = forwardRef<
...
>((props, ref) => {
  return (
    <ReactSelect
      ...
      className={cn(
        "focus:border-primary focus:ring-primary appearance-none rounded-md border border-primary-300 bg-white outline-none focus-within:ring-4 focus-within:ring-secondary-500 focus:outline-none focus:ring-1 focus:ring-secondary-500",
        props.className
      )}
...
CustomizedMultiDropDown.displayName = "Select";
