...
const FormInput = ({
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          "relative flex w-full min-w-36 cursor-pointer items-center justify-between gap-4 overflow-hidden rounded-sm border border-primary-500 p-0 hover:ring-4 hover:ring-secondary-500",
          classNames
        )}
      >
